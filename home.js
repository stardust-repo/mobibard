  ...
  const copy = {
    ko: {
      ...
      products: [
        ...
        ['rollscriptor', 'RollScriptor', '영상 → MIDI', '▥', '피아노 롤 영상을 분석해 건반의 Note On/Off를 MIDI로 복원합니다.'],
        ['veloscriptor', 'VeloScriptor', '오디오 → Velocity', '↟', 'MIDI와 동일 연주의 오디오를 비교해 각 노트의 Velocity를 다시 계산합니다.'],
        ['editor', 'Editor', 'MML / MIDI 편집', '✎', 'MML·MIDI를 피아노롤에서 편집하고 채널, 템포, 참조 오디오를 프로젝트로 관리합니다.'],
        ['mobibeats', 'MobiBeats', '리듬 게임', '◆', 'MML 또는 MIDI에서 4·5·6키 리듬 차트를 만들고 바로 플레이합니다.']
      ]
    },
    ja: {
      ...
      products: [
        ...
        ['rollscriptor', 'RollScriptor', '動画 → MIDI', '▥', 'ピアノロール動画を解析し、鍵盤のNote On/OffをMIDIとして復元します。'],
        ['veloscriptor', 'VeloScriptor', '音源 → Velocity', '↟', 'MIDIと同じ演奏の音源を比較し、各ノートのVelocityを再計算します。'],
        ['editor', 'Editor', 'MML / MIDI編集', '✎', 'MML・MIDIをピアノロールで編集し、チャンネル、テンポ、参照音源をプロジェクトとして管理します。'],
        ['mobibeats', 'MobiBeats', 'リズムゲーム', '◆', 'MMLまたはMIDIから4・5・6キーのリズム譜面を作成してすぐにプレイできます。']
      ]
    },
    en: {
    ...
    'zh-CN': {
      ...
      products: [
        ...
        ['editor', 'Editor', 'MML / MIDI编辑', '✎', '在钢琴卷帘中编辑MML与MIDI，并以项目方式管理声道、速度和参考音频。'],
    ...
    'zh-TW': {
      ...
      products: [
        ...
        ['editor', 'Editor', 'MML / MIDI編輯', '✎', '在鋼琴捲軸中編輯MML與MIDI，並以專案管理頻道、速度與參考音訊。'],
