export default {
  code: 'zh-CN', htmlLang: 'zh-Hans', strings: {
    ...
    'tutorial.step2_title': '调整琴键检测线', 'tutorial.step2_body': '在琴键未按下的画面，将青色白键线与粉色黑键线对准琴键主体。此时的未按下琴键颜色会固定为基准色。',
    'tutorial.step3_title': '设置分析范围与 MIDI', 'tutorial.step3_body': '指定开始和结束时间，并确认最左侧琴键、BPM 与力度。',
