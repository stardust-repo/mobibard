export default {
  code: 'ja', htmlLang: 'ja', strings: {
    ...
    'tutorial.step4_part': '解析・MIDI', 'tutorial.step4_title': '動画を解析してMIDI保存', 'tutorial.step4_body': '解析時間、BPM、ベロシティと必要に応じてノート拡張フレームを設定して解析します。拡張は同じ鍵盤の未検出フレームだけに適用され、ノート同士は結合しません。', 'tutorial.step4_note': '±1Fは1フレーム、±1秒ボタンは1秒ずつ移動します。',
