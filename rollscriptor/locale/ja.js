export default {
  code: 'ja', htmlLang: 'ja', strings: {
    ...
    'tutorial.step2_part': '鍵盤設定', 'tutorial.step2_title': '認識ラインを合わせる', 'tutorial.step2_body': '横/縦を選び、白鍵と黒鍵の認識ラインをそれぞれ鍵盤本体に合わせて変化量を調整します。', 'tutorial.step2_note': '白鍵変化量は35%、黒鍵変化量は50%が初期値です。値が大きいほど大きな色変化だけを押鍵として扱います。',
    ...
    'keyboard.detected_colors': '検出基準色', 'keyboard.white_colors': '白鍵', 'keyboard.black_colors': '黒鍵',
