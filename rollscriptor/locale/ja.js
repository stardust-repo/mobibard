export default {
  code: 'ja', htmlLang: 'ja', strings: {
    ...
    'tutorial.step4_part': '動画解析設定', 'tutorial.step4_title': '解析設定とMIDI保存', 'tutorial.step4_body': '解析時間を決め、ノート拡張、テンポ、ベロシティを設定して動画解析を実行します。ノート拡張は同じ鍵盤の前後にある未検出フレームだけに適用され、重なる場合は後続ノートを優先し、ノート同士は結合しません。', 'tutorial.step4_note': 'ノート拡張は0Fで無効です。解析後に結果を確認してMIDIをダウンロードします。',
