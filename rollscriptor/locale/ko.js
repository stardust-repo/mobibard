export default {
  code: 'ko', htmlLang: 'ko', strings: {
    ...
    'tutorial.step2_part': '건반 설정', 'tutorial.step2_title': '인식선 맞추기', 'tutorial.step2_body': '건반 방향을 수평/수직으로 맞춘 뒤 흰 건반과 검은 건반 인식선을 각각 건반 몸통에 맞추고 변화량을 조절합니다.', 'tutorial.step2_note': '흰 건반 변화량은 기본 35%, 검 건반 변화량은 기본 50%입니다. 값이 클수록 더 큰 색 변화만 눌림으로 인식합니다.',
    ...
    'keyboard.detected_colors': '검출 기준색', 'keyboard.white_colors': '흰 건반', 'keyboard.black_colors': '검은 건반',
