export default {
  code: 'ko', htmlLang: 'ko', strings: {
    ...
    'tutorial.step4_part': '영상 분석 설정', 'tutorial.step4_title': '분석 설정과 MIDI 저장', 'tutorial.step4_body': '분석 시간을 정한 뒤 노트 길이 확장, 템포, 벨로시티를 설정하고 영상 분석을 실행합니다. 노트 길이 확장은 같은 건반의 앞뒤 미검출 프레임에만 적용되며, 겹치면 후행 노트가 우선하고 두 노트는 합쳐지지 않습니다.', 'tutorial.step4_note': '노트 길이 확장은 0 / 0.25 / 0.5 / 1 프레임 중 하나를 선택합니다. 0은 사용 안 함입니다. 분석이 끝나면 결과를 확인하고 MIDI를 다운로드합니다.',
