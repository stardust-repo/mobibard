export default {
  code: 'ko', htmlLang: 'ko', strings: {
    ...
    'tutorial.step4_part': '영상 분석 설정', 'tutorial.step4_title': '분석 설정과 MIDI 저장', 'tutorial.step4_body': '분석 시간을 정한 뒤 노트 확장, 템포, 벨로시티를 설정하고 영상 분석을 실행합니다. 노트 확장은 같은 건반의 앞뒤 미검출 프레임에만 적용되며, 겹치면 후행 노트가 우선하고 두 노트는 합쳐지지 않습니다.', 'tutorial.step4_note': '노트 확장 0F는 사용 안 함입니다. 분석이 끝나면 결과를 확인하고 MIDI를 다운로드합니다.',
    ...
    'analysis.title': '영상 분석 설정', 'analysis.description': '분석 범위와 MIDI 설정을 지정한 뒤 영상을 분석하고 MIDI로 저장합니다.', 'analysis.range': '분석 시간',
    ...
    'settings.white_change': '흰 건반 변화량', 'settings.black_change': '검은 건반 변화량', 'settings.tempo': '템포 (BPM)', 'settings.velocity': '벨로시티', 'settings.note_extension': '노트 확장 (프레임)', 'settings.note_extension_help': '검출된 노트를 앞뒤의 미검출 프레임으로 확장합니다. 확장이 겹치면 후행 노트가 우선하며 두 노트는 합쳐지지 않습니다.',
