export default {
  code: 'ko', htmlLang: 'ko', strings: {
    ...
    'tutorial.step2_part': '건반 설정', 'tutorial.step2_title': '인식선 맞추기', 'tutorial.step2_body': '2선 모드 또는 1선 모드를 선택하고 건반 방향을 수평/수직으로 맞춥니다. 2선은 흰/검 건반에 각각, 1선은 88건반 전체를 가로지르도록 인식선을 맞춘 뒤 변화량을 조절합니다.', 'tutorial.step2_note': '흰 건반 변화량은 기본 30%, 검은 건반 변화량은 기본 50%입니다. 값이 클수록 더 큰 색 변화만 눌림으로 인식합니다.',
