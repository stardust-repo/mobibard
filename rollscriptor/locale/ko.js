export default {
  code: 'ko', htmlLang: 'ko', strings: {
    ...
    'tutorial.step4_part': '분석 · MIDI', 'tutorial.step4_title': '영상 분석과 MIDI 저장', 'tutorial.step4_body': '분석 시간, BPM, 벨로시티와 필요하면 노트 확장 프레임을 정하고 영상 분석을 실행합니다. 노트 확장은 같은 건반의 미검출 프레임에만 적용되며 노트를 합치지 않습니다.', 'tutorial.step4_note': '±1F는 한 프레임, ±1초 버튼은 한 번에 1초씩 이동합니다.',
    ...
    'settings.white_change': '흰 건반 변화량', 'settings.black_change': '검 건반 변화량', 'settings.tempo': '템포 (BPM)', 'settings.velocity': '벨로시티', 'settings.note_extension': '노트 확장 (프레임)', 'settings.note_extension_help': '검출된 노트를 앞뒤의 미검출 프레임으로 확장합니다. 확장이 겹치면 후행 노트가 우선하며 두 노트는 합쳐지지 않습니다.',
