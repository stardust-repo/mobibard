(() => {
  ...
  const FALLBACK_MESSAGES = {
    ...
    "xml.err_central_dir": "MXL 압축 파일의 중앙 디렉터리를 읽지 못했습니다.",
    "xml.err_compression": "지원하지 않는 MXL 압축 방식입니다: {0}",
    "xml.err_decompress_unsupported": "이 브라우저에서는 MXL 압축 해제를 지원하지 않습니다. .musicxml 또는 .xml 파일을 사용하세요.",
