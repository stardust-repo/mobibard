...
export function parseGp3File(data) { const buf = new ArrayBuffer(data.byteLength); new Uint8Array(buf).set(data); const r = new GP3Reader(buf), version = r.readByteSizeString(30); if (!version.includes('GUITAR PRO') || !version.includes('v3'))
