...
| 프로젝트 | 영향 범위 |
|---|---|
| Simple | 기본 내장 SoundFont를 Compact `FluidR3Mono_GM_compact.sf3`로 교체했습니다. 기존 간편 생성·미리듣기 동작은 유지합니다. |
| Player | 기본 내장 SoundFont를 Compact 버전으로 교체했습니다. 피아노롤의 균등 12반음 노트 두께와 최대폭 이하 전체폭 레이아웃, Simple과 맞춘 모바일 상단바는 유지합니다. |
| Editor | 기본 내장 SoundFont를 Compact 버전으로 교체했으며 기존 공용 SoundBank 재생 경로를 유지합니다. |
| MobiBeats | 기본 내장 SoundFont를 Compact 버전으로 교체하고 배포 매니페스트의 크기·SHA-256을 갱신했습니다. |
