export default { code:'ja', htmlLang:'ja', strings:{
  ...
  'section.analysis_title':'音量解析', 'section.analysis_description':'各ノート開始点の基音と倍音アタックを測定し、元MIDIのNote Onベロシティだけを置き換えます。', 'section.download_title':'MIDIダウンロード', 'section.download_description':'音量解析の結果を確認し、元音源と聴き比べてからMIDIをダウンロードします。',
  ...
  'preview.source':'元ソース',
  'preview.mix_aria':'左はMIDI、右は元ソースになるようにクロスフェード', 'preview.mix_midi':'MIDI', 'preview.mix_original':'原音',
