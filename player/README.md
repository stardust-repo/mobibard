...
마지막 갱신: 2026-08-19 02:37:00 KST
...
- 상단바는 본문 위의 일반 문서 흐름에 배치되어 페이지를 스크롤하면 콘텐츠와 함께 위로 이동하며, 좌우에 화면 폭별 안쪽 여백을 둡니다.
- 좌측에는 공용 모비바드 아이콘과 브랜드를 표시하고, 우측에는 추천 사이트, Discord, 계정·언어·테마 메뉴를 배치합니다.
